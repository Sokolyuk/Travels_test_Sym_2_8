...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'xhrequester' => 'getXhrequesterService',
        );
        $this->aliases = array(
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TravelsServiceBundle', ($this->targetDirs[2].'/Resources/TravelsServiceBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TravelsServiceBundle', ($this->targetDirs[3].'\\src\\Travels\\Bundle\\ServiceBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TravelsMainBundle', ($this->targetDirs[2].'/Resources/TravelsMainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TravelsMainBundle', ($this->targetDirs[3].'\\src\\Travels\\Bundle\\MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4f678b0d2e0e43b63069dfb1eb2804e624b131c44501b1afd88bf30bc3d510f8');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'TravelsServiceBundle', 8 => 'TravelsMainBundle', 9 => 'AsseticBundle', 10 => 'DebugBundle', 11 => 'WebProfilerBundle', 12 => 'SensioDistributionBundle', 13 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Travels\\Bundle\\MainBundle/Resources/views'), 'TravelsMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d30cc3887729140f97bcf1ac59dfc64933329537');
    }
    ...
    /**
     * Gets the 'xhrequester' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Travels\Bundle\ServiceBundle\Classes\XHRequesterImpl A Travels\Bundle\ServiceBundle\Classes\XHRequesterImpl instance.
     */
    protected function getXhrequesterService()
    {
        return $this->services['xhrequester'] = new \Travels\Bundle\ServiceBundle\Classes\XHRequesterImpl();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5764f9f1355c78.26023149')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TravelsServiceBundle' => 'Travels\\Bundle\\ServiceBundle\\TravelsServiceBundle',
                'TravelsMainBundle' => 'Travels\\Bundle\\MainBundle\\TravelsMainBundle',
            ...
            'secret' => 'd30cc3887729140f97bcf1ac59dfc64933329537',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd30cc3887729140f97bcf1ac59dfc64933329537',
            ...
            'assetic.ruby.bin' => 's:\\dev\\Ruby21-x64\\bin\\ruby.EXE',
            'assetic.sass.bin' => 's:\\dev\\Ruby21-x64\\bin\\sass.BAT',
