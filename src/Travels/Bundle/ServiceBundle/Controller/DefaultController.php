...
namespace Travels\Bundle\ServiceBundle\Controller;
...
use Travels\Bundle\ServiceBundle\Classes\XHRequesterInterface;
...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('TravelsServiceBundle:Default:index.html.twig');
    }
